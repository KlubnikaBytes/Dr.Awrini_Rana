  ...
  return (
    <div className="bg-white rounded shadow-sm hp-admin-card h-100 d-flex flex-column">
      ...
      <div className="d-flex border-bottom px-3 pt-2">
        <NavLink to="list" className={({isActive}) => `hp-tertiary-nav-item ${isActive ? 'active' : ''}`}>Staff</NavLink>
        <NavLink to="referral-doctors" className={({isActive}) => `hp-tertiary-nav-item ${isActive ? 'active' : ''}`}>Referral Doctors</NavLink>
        <NavLink to="vendors" className={({isActive}) => `hp-tertiary-nav-item ${isActive ? 'active' : ''}`}>Vendors</NavLink>
      </div>
